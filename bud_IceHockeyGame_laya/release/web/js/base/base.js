...
function importBase() {
	...
	base.init = function(options) {
		...
		if(this.dir == 'portrait') {
			...
			document.write('<aside class="turnBoxPortrait" id="turnBox"><div class="phone"><img src="https://upload.cdn.be-xx.com/dior-cny/images/common/turn_phone.png"><i class="yes"></i><i class="no"></i></div><p>竖屏体验更佳</p></aside>');
			...
			if(this.landscapeLock) {
				document.write('<aside class="turnBoxLandscape" id="turnBox"><div class="lock"><span></span><span></span></div><div class="sign"><span>竖排方向锁定：关闭</span><span>竖排方向锁定：打开</span></div><div class="phone"><img src="https://upload.cdn.be-xx.com/dior-cny/images/common/turn_phone.png"><i class="yes"></i><i class="no"></i></div><p>锁定竖屏体验更佳</p></aside>');
				this.turnBox = document.getElementById("turnBox");
